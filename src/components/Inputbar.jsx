...
//       e.preventDefault()
//       SetisLoading(true)
//       axiosInstance.get(`?apikey=${apikey}&s=${query}`)
//       .then((res) => {
//         console.log(res);
...
//       {isLoading}
//       <form className="flex justify-center items-center" onSubmit={fetchMovies} >
//         <input
//           onChange={(e) => setQuery(e.target.value)}
//           value={query}
//           className="bg-white mt-3 rounded p-2 w-[400px] "
//           type="text"
//           placeholder="Search Movies"
//         />
//         <div className="flex justify-center mt-2">
//          <button  className="border bg-amber-50 p-2 rounded-2xl">Search</button>
//       </div>
//       </form>
...
//       <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 py-3 px-4 gap-3">
//         {movies.length> 0 &&
//          movies.map((movie)=>{
//             return(
